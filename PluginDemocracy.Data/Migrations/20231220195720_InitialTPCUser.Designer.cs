...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseCitizenCommunity", b =>
                {
                    b.Property<int>("NonResidentialCitizenInId")
                        .HasColumnType("int");

                    b.Property<int>("NonResidentialCitizensId")
                        .HasColumnType("int");

                    b.HasKey("NonResidentialCitizenInId", "NonResidentialCitizensId");

                    b.HasIndex("NonResidentialCitizensId");

                    b.ToTable("BaseCitizenCommunity");
                });
            ...
            modelBuilder.Entity("BaseCitizenCommunity", b =>
                {
                    b.HasOne("PluginDemocracy.Models.Community", null)
                        .WithMany()
                        .HasForeignKey("NonResidentialCitizenInId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PluginDemocracy.Models.BaseCitizen", null)
                        .WithMany()
                        .HasForeignKey("NonResidentialCitizensId")
            ...
            modelBuilder.Entity("PluginDemocracy.Models.Community", b =>
                {
                    ...
                    b.HasOne("PluginDemocracy.Models.BaseCitizen", null)
                        .WithOne()
                        .HasForeignKey("PluginDemocracy.Models.Community", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PluginDemocracy.Models.User", b =>
                {
                    b.HasOne("PluginDemocracy.Models.BaseCitizen", null)
                        .WithOne()
                        .HasForeignKey("PluginDemocracy.Models.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PluginDemocracy.Models.Home", b =>
                {
                    ...
                    b.HasOne("PluginDemocracy.Models.Community", null)
                        .WithOne()
                        .HasForeignKey("PluginDemocracy.Models.Home", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
