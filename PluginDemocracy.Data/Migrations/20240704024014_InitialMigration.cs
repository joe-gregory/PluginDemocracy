        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Home_Communities_ResidentialCommunityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Petitions_Communities_ResidentialCommunityId",
                        column: x => x.ResidentialCommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Petitions_Communities_ResidentialCommunityId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Communities_CommunityAuthorId",
                        column: x => x.CommunityAuthorId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Posts_Communities_ResidentialCommunityId",
                        column: x => x.ResidentialCommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Posts_Communities_ResidentialCommunityId1",
                        column: x => x.ResidentialCommunityId1,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ResidentialCommunityUser",
                columns: table => new
                {
                    CitizenshipsId = table.Column<int>(type: "int", nullable: false),
                    HomeOwnersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidentialCommunityUser", x => new { x.CitizenshipsId, x.HomeOwnersId });
                    table.ForeignKey(
                        name: "FK_ResidentialCommunityUser_Communities_CitizenshipsId",
                        column: x => x.CitizenshipsId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResidentialCommunityUser_Users_HomeOwnersId",
                        column: x => x.HomeOwnersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Role_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeOwnership_Communities_ResidentialCommunityId",
                        column: x => x.ResidentialCommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeOwnership_ResidentialCommunityId",
                table: "HomeOwnership",
                column: "ResidentialCommunityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidentialCommunityUser_HomeOwnersId",
                table: "ResidentialCommunityUser",
                column: "HomeOwnersId");
