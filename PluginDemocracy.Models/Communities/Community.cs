...
namespace PluginDemocracy.Models
{
    ...
    /// 
    /// </summary>
    public class Community : IAvatar
    {
        #region PROPERTIES
        ...
        public List<User> Citizens
        {
            get
            {
                List<User> homeOwners = Homes?.SelectMany(home => home.OwnersWithOwnership.Keys).ToList() ?? [];
...
#       pragma warning restore CS8618
        ...
        /// show up as a citizen in <see cref="Community.Citizens"/>. 
        /// The request should be located in <see cref="Community.JoinCommunityRequests"/> in order to be able to approve it. 
        /// </summary>
        /// <param name="request">The request you want to approve.</param>
        /// <exception cref="ArgumentException">Thrown if request is not found in <see cref="Community.JoinCommunityRequests"/> or
        /// if <see cref="JoinCommunityRequest.Home"/> does not match a <see cref="Home"/> in <see cref="Community.Homes"/> or if
